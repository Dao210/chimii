...
*/}}
{{- define "chimii.labels" -}}
app.kubernetes.io/name: chimii
...
under the kustomize layout when installed as `helm install chimii ...`.
*/}}
{{- define "chimii.backend.fullname" -}}
{{ .Release.Name }}-backend
{{- end -}}

{{- define "chimii.frontend.fullname" -}}
{{ .Release.Name }}-frontend
{{- end -}}

{{- define "chimii.postgres.fullname" -}}
...
*/}}
{{- define "chimii.databaseUrl" -}}
postgres://$(POSTGRES_USER):$(POSTGRES_PASSWORD)@{{ include "chimii.postgres.fullname" . }}:5432/$(POSTGRES_DB)?sslmode=disable
{{- end -}}
