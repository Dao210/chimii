 ...
 * The UI wiring is covered by `chat-input.test.tsx` in @chimii/views; this
...
const DATABASE_URL =
  process.env.DATABASE_URL ?? "postgres://chimii:chimii@localhost:5432/chimii?sslmode=disable";
