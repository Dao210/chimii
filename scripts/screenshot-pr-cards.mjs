...
const DB = process.env.DATABASE_URL || "postgres://chimii:chimii@localhost:5432/chimii_chimii_101?sslmode=disable";
...
async function main() {
  ...
  await page.evaluate((t) => localStorage.setItem("chimii_token", t), token);
