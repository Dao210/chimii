...
postgres_db="chimii_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://chimii:chimii@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
CHIMII_DEV_VERIFICATION_CODE=888888
CHIMII_SERVER_URL=ws://localhost:${backend_port}/ws
