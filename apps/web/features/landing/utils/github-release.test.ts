...
const SAMPLE_LATEST_ASSET = {
  name: "chimii-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/chimii-ai/chimii/releases/download/v0.2.14/chimii-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "chimii-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/chimii-ai/chimii/releases/download/v0.2.13/chimii-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/chimii-ai/chimii/releases/tag/${overrides.tag}`,
