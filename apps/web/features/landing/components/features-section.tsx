...
import { StatusIcon, PriorityIcon } from "@chimii/views/issues/components";
import { STATUS_CONFIG } from "@chimii/core/issues/config/status";
import { PRIORITY_CONFIG } from "@chimii/core/issues/config/priority";
import type { IssueStatus, IssuePriority } from "@chimii/core/types";
    ...
    <div className="relative aspect-video overflow-hidden rounded-lg border bg-background text-foreground shadow-2xl">
      ...
      <div className="flex h-10 shrink-0 items-center border-b bg-background px-4 text-sm">
        <div className="flex items-center gap-1.5 min-w-0 text-xs">
          <span className="text-muted-foreground">Chimii Demo</span>
...
const mockToolCalls = [
  ...
  { type: "tool_result" as const, preview: "ok  \tgithub.com/chimii/server/internal/handler\t0.847s" },
];
        ...
        <div className="relative lg:flex lg:gap-20">
          ...
          <div className="flex-1">
            {features.map((feature, i) => (
              ...
              >
                {/* Title + description */}
                <h2 className="font-semibold text-[2.6rem] leading-[1.05] tracking-[-0.03em] text-[#0a0d12] sm:text-[3.4rem] lg:text-[4.2rem]">
                  {feature.title}
                </h2>
                ...
                <div className="mt-14 sm:mt-18">
                  <div className="overflow-hidden rounded-sm border border-[#0a0d12]/8 bg-[#f5f5f5]">
