...
export const metadata: Metadata = {
  title: "Download Chimii",
  description:
    "Download Chimii for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download Chimii",
    description:
      "Get the Chimii desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
