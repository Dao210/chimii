...
// cookie mode on their next logout/login cycle (logout clears chimii_token).
// Sunset: once telemetry shows <1% of sessions still carry chimii_token,
...
function hasLegacyToken(): boolean {
  ...
  try {
    return Boolean(window.localStorage.getItem("chimii_token"));
  } catch {
    return false;
  }
}
