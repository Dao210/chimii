...
} from "@chimii/core/billing/recovery";
import { BILLING_WORKSPACE_SUBSCRIPTIONS_FLAG } from "@chimii/core/feature-flags";
  ...
  switch (recovery) {
    ...
    case "billing_unavailable":
      return billingUrl ? (
        ...
        <Text className="text-sm leading-5 text-muted-foreground">
          Open Chimii on the web to review billing options.
        </Text>
      );
  }
}
