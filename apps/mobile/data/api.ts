 ...
 *
 * Types are imported via `import type` from @chimii/core/types — zero
 * runtime coupling. Zod schemas + fallbacks are imported from
 * @chimii/core/api/schemas (pure data, on the mobile sharing whitelist).
 *
 ...
 *  reasonable Chimii payload size on cellular. */
