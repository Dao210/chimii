...
import { ProjectsPage } from "@chimii/views/projects/components";
import { DashboardPage } from "@chimii/views/dashboard";
import { AutopilotsPage } from "@chimii/views/autopilots/components";
import { MyIssuesPage } from "@chimii/views/my-issues";
import { SkillsPage } from "@chimii/views/skills";
import { DesktopRuntimesPage } from "./components/desktop-runtimes-page";
import { DesktopAgentsPage } from "./components/desktop-agents-page";
import { AgentCreationStudio } from "@chimii/views/agents";
import { SquadsPage, SquadDetailPage as SquadDetailPageView } from "@chimii/views/squads/components";
import { InboxPage } from "@chimii/views/inbox";
import { ChatPage } from "@chimii/views/chat";
import { SettingsPage } from "@chimii/views/settings";
