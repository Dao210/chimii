...
import { getOrCreateInstallId, utcDay } from "@chimii/core/client-usage";
import { defaultStorage } from "@chimii/core/platform";
import type { LocalRuntimeProbe } from "../../../shared/daemon-types";

const LAST_RUNTIME_PREFIX = "chimii_runtime_probe_last_reported";
