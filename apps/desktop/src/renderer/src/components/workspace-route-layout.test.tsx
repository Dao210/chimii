...
vi.mock("@chimii/core/platform", () => ({
  setCurrentWorkspace: vi.fn(),
}));

vi.mock("@chimii/core/workspace", async () => {
  const actual = await vi.importActual<typeof import("@chimii/core/workspace")>(
    "@chimii/core/workspace",
  );
  return {
    ...actual,
...
vi.mock("@chimii/views/workspace/use-workspace-seen", () => ({
  useWorkspaceSeen: () => state.workspaceSeen,
}));

vi.mock("@chimii/views/workspace/welcome-after-onboarding", () => ({
  WelcomeAfterOnboarding: () => null,
}));

vi.mock("@chimii/views/layout", () => ({
...
vi.mock("@chimii/views/onboarding", () => ({
  SourceBackfillModal: () => {
