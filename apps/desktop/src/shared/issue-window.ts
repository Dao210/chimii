export const ISSUE_WINDOW_ARGUMENT_PREFIX = "--chimii-issue-window=";
...
export function parseIssueWindowPath(
  ...
  let url: URL;
  try {
    url = new URL(value, "https://desktop.chimii.invalid");
  } catch {
    return null;
  }
  if (url.origin !== "https://desktop.chimii.invalid") return null;
