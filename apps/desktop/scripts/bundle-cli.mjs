#!/usr/bin/env node
// Builds the `chimii` CLI from server/cmd/chimii and copies the binary
...
//
// ldflags mirror `make build` so `chimii --version` reports a meaningful
// version / commit / date.
//
...
function binaryNameForPlatform(platform) {
  return platform === "win32" ? "chimii.exe" : "chimii";
}
