...
func newBusinessEventMetrics() *businessEventMetrics {
	return &businessEventMetrics{
		...
		}, metricLabels("chimii_chat_output_local_path_total")),
	}
}
