...
func NewBusinessMetrics() *BusinessMetrics {
	...
	m := &BusinessMetrics{
		...
		}, metricLabels("chimii_agent_task_queue_wait_seconds")),
		taskRunSeconds: prometheus.NewHistogramVec(prometheus.HistogramOpts{
			...
			Buckets:   taskDurationBuckets,
		}, metricLabels("chimii_agent_task_run_seconds")),
		taskTotalSeconds: prometheus.NewHistogramVec(prometheus.HistogramOpts{
			...
			Buckets:   taskDurationBuckets,
		}, metricLabels("chimii_agent_task_total_seconds")),
		...
		}, metricLabels("chimii_agent_task_in_progress")),
		...
		}, metricLabels("chimii_llm_unpriced_tokens_total")),
		...
		}, metricLabels("chimii_llm_request_total")),
		...
		}, metricLabels("chimii_task_queued_expired_total")),
		...
		}, metricLabels("chimii_task_lease_expired_total")),
		activeTasks: map[string]activeTaskLabels{},
