...
// (Chimii Cloud Node) PAT. Tokens with this prefix are validated by
// calling the Chimii Cloud Fleet service rather than by hitting our
...
// CHIMII_CLOUD_FLEET_URL configured simply rejects mcn_ tokens at
...
type CloudPATVerifierConfig struct {
	...
	// https://fleet.chimii.cloud). Trailing slashes are trimmed.
