...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.chimii.ai"
	cookieDomain string // cookie scope, e.g. ".chimii.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.chimii.ai")
//   - COOKIE_DOMAIN           (e.g. ".chimii.ai")
