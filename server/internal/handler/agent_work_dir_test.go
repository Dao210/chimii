...
func TestRelativeWorkDir(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			workDir:  "/Users/alice/chimii_workspaces/" + wsID + "/5c57b65b/workdir",
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/alice/chimii_workspaces/" + wsID + "/5c57b65b",
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/df007df/code/work/projects/chimii/foo",
			wsID:     wsID,
			taskID:   taskID,
			expected: "code/work/projects/chimii/foo",
		},
		{
		...
		},
		{
			...
			workDir:  `C:\Users\alice\chimii_workspaces\` + wsID + `\5c57b65b\workdir`,
			wsID:     wsID,
			taskID:   taskID,
			expected: wsID + "/5c57b65b/workdir",
		},
		{
			...
			wsID:     "",
			taskID:   taskID,
			expected: "chimii_workspaces/" + wsID + "/5c57b65b/workdir",
		},
		{
