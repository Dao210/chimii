...
func TestCanInvokeAgent_PublicToMemberWhitelist(t *testing.T) {
	...
	allowedMember := createPermissionTestMember(t, "perm-allowed-member@chimii.test")
	otherMember := createPermissionTestMember(t, "perm-other-member@chimii.test")
...
func TestCanInvokeAgent_MixedMemberAndTeamTargets(t *testing.T) {
	...
	memberA := createPermissionTestMember(t, "perm-mix-a@chimii.test")
	memberB := createPermissionTestMember(t, "perm-mix-b@chimii.test")
...
func TestUpdateAgent_BatchReplaceOverlappingMembers(t *testing.T) {
	...
	memberA := createPermissionTestMember(t, "perm-batch-a@chimii.test")
	memberB := createPermissionTestMember(t, "perm-batch-b@chimii.test")
	memberC := createPermissionTestMember(t, "perm-batch-c@chimii.test")
...
func TestUpdateAgent_WorkspaceStacksWithMembersThenNarrowed(t *testing.T) {
	...
	memberA := createPermissionTestMember(t, "perm-stack-a@chimii.test")
	memberB := createPermissionTestMember(t, "perm-stack-b@chimii.test")
	...
	memberC := createPermissionTestMember(t, "perm-stack-c@chimii.test")
	w := httptest.NewRecorder()
	r := newRequest("PUT", "/api/agents/"+agentID, map[string]any{
		"permission_mode": "public_to",
		"invocation_targets": []map[string]any{
...
func TestCreateAgent_EmptyPublicToNormalizesToWorkspace(t *testing.T) {
	...
	someMember := createPermissionTestMember(t, "perm-emptypublic-m@chimii.test")
...
func TestCanInvokeAgent_SystemWorkspaceExceptionAndMemberFailClosed(t *testing.T) {
	...
	memberX := createPermissionTestMember(t, "perm-sys-failclosed@chimii.test")
...
func TestRevokeMember_ClearsInvocationTargets(t *testing.T) {
	...
	memberX := createPermissionTestMember(t, "perm-revoke-x@chimii.test")
...
func TestRevokeMember_InvocationTargetCleanupIsWorkspaceScoped(t *testing.T) {
	...
	userX := createPermissionTestMember(t, "perm-xws@chimii.test")
...
func TestUpdateAgent_AccessChangeIsOwnerOnly(t *testing.T) {
	...
	adminID := createPermissionTestAdmin(t, "perm-access-admin@chimii.test")
...
func TestUpdateAgent_LegacyVisibilityNoOpForMemberOnlyPublicTo(t *testing.T) {
	...
	memberX := createPermissionTestMember(t, "perm-legacyvis-x@chimii.test")
	agentID := createPublicToAgentWithTargets(t, "legacy-vis-member-only-agent", []map[string]any{
		{"target_type": "member", "target_id": memberX},
	})
	adminID := createPermissionTestAdmin(t, "perm-legacyvis-admin@chimii.test")
