...
func (h *Handler) GetChildMode(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, childModeResponse{
		...
		Capabilities: []string{"build:create", "creations:read", "creations:export", "inventory:read", "inventory:write", "circuit:create", "circuit:read", "circuit:progress"},
	})
}
...
func (h *Handler) EnterChildMode(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, map[string]any{
		"token": token,
		"mode":  childModeResponse{Mode: "child", Profile: ptrChildProfile(childProfileToResponse(profile)), Capabilities: []string{"build:create", "creations:read", "creations:export", "inventory:read", "inventory:write", "circuit:create", "circuit:read", "circuit:progress"}},
	})
}
