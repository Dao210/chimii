...
func buildTestDB(t *testing.T) (*Handler, *pgxpool.Pool, db.BuildSession) {
	...
	for _, n := range []string{"234", "235", "236", "237", "246", "247", "248", "257", "258", "259", "260", "261", "262", "263", "268", "269", "270", "271", "272", "279", "280", "281", "282", "283", "284", "285", "289", "290", "291", "292", "293", "294", "295"} {
