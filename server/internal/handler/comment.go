...
// emitted via the X-Chimii-Next-Before / X-Chimii-Next-Before-Id
// response headers.
//
...
func (h *Handler) ListComments(w http.ResponseWriter, r *http.Request) {
	...
	if result.NextBefore != "" && result.NextBeforeID != "" {
		w.Header().Set("X-Chimii-Next-Before", result.NextBefore)
		w.Header().Set("X-Chimii-Next-Before-Id", result.NextBeforeID)
	}
