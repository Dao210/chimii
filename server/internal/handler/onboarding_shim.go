...
import (
	...
	"github.com/chimii-ai/chimii/server/internal/issueguard"
...
const (
	onboardingAssistantName = "Chimii Helper"
	onboardingIssueTitle    = "Start here: learn Chimii with Chimii Helper"
	onboardingAgentTemplate = "chimii_helper"
...
const onboardingAssistantDescription = "Built-in workspace assistant. Answers Chimii questions and runs CLI operations."
...
// Chimii Helper agent created by this shim. Pre-v3 desktop submits a
...
// is removed.
const onboardingAssistantInstructions = `You are Chimii Helper, the built-in AI assistant for this Chimii workspace. Your role is to help any member use Chimii better — answer questions, give advice, and execute workspace operations on their behalf.
...
const onboardingIssueDescription = `Welcome to Chimii.

This is your guided first run. Chimii Helper is assigned to this issue and will help you try the core workflow:

1. Read Chimii Helper's first comment.
2. Reply with something you want to build, fix, write, or plan.
3. @mention Chimii Helper when you want it to continue.
...
//
// Creates or reuses one "Chimii Helper" agent on the supplied runtime,
...
func enNoRuntimeIssueDescription() string {
	return strings.Join([]string{
		"Welcome to Chimii.",
		"",
		"Agents need a runtime before they can execute work. You can still use Chimii as a lightweight project-management workspace while you install one.",
		"",
		"## Try Chimii first",
		"",
		...
		"",
		"Full guide: https://chimii.ai/docs/install-agent-runtime",
		"",
		...
		"   which codex",
		"   codex --version",
		"5. Restart the Chimii daemon:",
		"   chimii daemon restart",
		...
		"",
		"When the runtime is connected, you can create Chimii Helper for a guided first run.",
	}, "\n")
}
...
func zhNoRuntimeIssueDescription() string {
	return strings.Join([]string{
		"欢迎来到 Chimii。",
		"",
		"智能体需要先连上运行时才能执行工作。运行时还没准备好时，你也可以先把 Chimii 当作轻量项目管理工具体验起来。",
		"",
		"## 先体验项目管理功能",
		"",
		"运行时安装前，你可以先做这些事：",
		...
		"## 安装第一个 Agent 运行时",
		"",
		"完整文档：https://chimii.ai/docs/install-agent-runtime",
		"",
		"中文用户建议先装 Kimi CLI：",
		"",
		...
		"",
		"运行时连上后，你就可以创建 Chimii Helper，开始一次有智能体参与的上手引导。",
	}, "\n")
}
