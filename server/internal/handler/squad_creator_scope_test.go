...
func TestCreateSquad_PlainMemberBecomesCreator(t *testing.T) {
	...
	memberID := createPlainMember(t, "squad-creator@chimii.test")
...
func TestManageSquad_CreatorCanManageOwn(t *testing.T) {
	...
	memberID := createPlainMember(t, "squad-owner-manage@chimii.test")
...
func TestManageSquad_StrangerMemberForbidden(t *testing.T) {
	...
	creatorID := createPlainMember(t, "squad-stranger-creator@chimii.test")
	strangerID := createPlainMember(t, "squad-stranger-other@chimii.test")
