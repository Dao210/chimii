...
import (
	...
	"github.com/chimii-ai/chimii/server/internal/integrations/vcs"
...
func (h *Handler) ConnectVCS(w http.ResponseWriter, r *http.Request) {
	...
	if !h.isVCSConfigured() {
		writeError(w, http.StatusServiceUnavailable, "vcs integration not configured (CHIMII_VCS_SECRET_KEY unset)")
		return
	}
