...
func TestAutopilotCollaborator_GrantedMemberCanWrite(t *testing.T) {
	...
	member := createPlainMember(t, "ap-collab-grantee@chimii.test")
...
func TestAutopilotCollaborator_NonWriterCannotGrant(t *testing.T) {
	...
	stranger := createPlainMember(t, "ap-collab-stranger@chimii.test")
	victim := createPlainMember(t, "ap-collab-victim@chimii.test")
...
func TestAutopilotCollaborator_CannotManageAccessList(t *testing.T) {
	...
	carol := createPlainMember(t, "ap-collab-carol@chimii.test")
	dave := createPlainMember(t, "ap-collab-dave@chimii.test")
	bob := createPlainMember(t, "ap-collab-bob2@chimii.test")
...
func TestAutopilotWrite_PlainMemberCannotMutateOthers(t *testing.T) {
	...
	member := createPlainMember(t, "ap-perm-stranger@chimii.test")
...
func TestAutopilotWrite_CreatorCanMutateOwn(t *testing.T) {
	...
	member := createPlainMember(t, "ap-perm-creator@chimii.test")
...
func TestAutopilotWrite_AdminCanMutateMembersAutopilot(t *testing.T) {
	...
	member := createPlainMember(t, "ap-perm-admin-target@chimii.test")
...
func TestAutopilotWrite_WebhookSecretRedactedForNonWriter(t *testing.T) {
	...
	stranger := createPlainMember(t, "ap-perm-secret-stranger@chimii.test")
