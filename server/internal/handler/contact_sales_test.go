...
func TestCanonicalBusinessEmail(t *testing.T) {
	cases := []struct {
		...
		{"plain", "ada@chimii.ai", "ada@chimii.ai", true},
		{"uppercase normalized", "Ada@Chimii.AI", "ada@chimii.ai", true},
		{"trim whitespace", "  ada@chimii.ai  ", "ada@chimii.ai", true},
		{"display name stripped", "Ada Lovelace <ada@chimii.ai>", "ada@chimii.ai", true},
		{"angle-bracketed", "<ada@chimii.ai>", "ada@chimii.ai", true},
		{"empty", "", "", false},
		{"only whitespace", "   ", "", false},
		{"missing at", "no-at-sign", "", false},
		{"missing local", "@chimii.ai", "", false},
