...
const (
	handlerTestEmail         = "handler-test@chimii.ai"
...
func TestMain(m *testing.M) {
	...
	if dbURL == "" {
		dbURL = "postgres://chimii:chimii@localhost:5432/chimii?sslmode=disable"
	}
...
func TestSendCode(t *testing.T) {
	w := httptest.NewRecorder()
	body := map[string]string{"email": "sendcode-test@chimii.ai"}
	var buf bytes.Buffer
	json.NewEncoder(&buf).Encode(body)
	...
	t.Cleanup(func() {
		testPool.Exec(context.Background(), `DELETE FROM verification_code WHERE email = $1`, "sendcode-test@chimii.ai")
	})
}
...
func TestSendCodeDbError(t *testing.T) {
	...
	w := httptest.NewRecorder()
	body := map[string]string{"email": "dberror-test@chimii.ai"}
	var buf bytes.Buffer
	json.NewEncoder(&buf).Encode(body)
	req := httptest.NewRequest("POST", "/auth/send-code", &buf)
	req.Header.Set("Content-Type", "application/json")
...
func TestSendCodeRateLimit(t *testing.T) {
	const email = "ratelimit-test@chimii.ai"
	t.Cleanup(func() {
...
func TestVerifyCode(t *testing.T) {
	const email = "verify-test@chimii.ai"
	ctx := context.Background()
...
func TestVerifyCodeRejectsDevCodeUnlessExplicitlyConfigured(t *testing.T) {
	...
	const email = "dev-code-disabled-test@chimii.ai"
	ctx := context.Background()
...
func TestVerifyCodeAcceptsConfiguredDevCodeOutsideProduction(t *testing.T) {
	...
	const email = "dev-code-enabled-test@chimii.ai"
	ctx := context.Background()
...
func TestVerifyCodeRejectsConfiguredDevCodeInProduction(t *testing.T) {
	...
	const email = "dev-code-production-test@chimii.ai"
	ctx := context.Background()
...
func TestVerifyCodeWrongCode(t *testing.T) {
	...
	const email = "wrong-code-test@chimii.ai"
	ctx := context.Background()
...
func TestVerifyCodeBruteForceProtection(t *testing.T) {
	...
	const email = "bruteforce-test@chimii.ai"
	ctx := context.Background()
...
func TestVerifyCodeNewUserHasNoWorkspace(t *testing.T) {
	const email = "workspace-verify-test@chimii.ai"
	ctx := context.Background()
