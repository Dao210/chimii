...
import (
	...
	agentpkg "github.com/chimii-ai/chimii/server/pkg/agent"
...
// translates the prompt into a `chimii issue create` invocation in the
...
// the agent's `chimii issue create` invocation passes `--project <uuid>`
...
// metadata column is JSONB on the wire; the daemon stores the chimii CLI
...
func (h *Handler) BatchUpdateIssues(w http.ResponseWriter, r *http.Request) {
	...
	// count match reality. See chimii-ai/chimii#1660.
