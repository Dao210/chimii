...
import (
	...
	"github.com/chimii-ai/chimii/server/internal/metrics"
...
func seedReconcilerFixture(t *testing.T, pool *pgxpool.Pool) reconcilerFixture {
	...
	if err := pool.QueryRow(ctx, `INSERT INTO "user" (name, email) VALUES ($1, $2) RETURNING id`,
		"Reconciler test", fmt.Sprintf("media-reconciler-%d@chimii.test", suffix)).Scan(&userID); err != nil {
	...
	if err := pool.QueryRow(ctx, `
		...
		VALUES ($1, $2, 'local', 'chimii_daemon', $3) RETURNING id`,
