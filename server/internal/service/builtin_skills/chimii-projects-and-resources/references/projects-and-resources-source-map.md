...
- `server/cmd/chimii/cmd_project.go` registers project `list`, `get`, `create`, `update`, `delete`, and `status`.
...
- Project resources are written into `.chimii/project/resources.json` for agent workdirs.
