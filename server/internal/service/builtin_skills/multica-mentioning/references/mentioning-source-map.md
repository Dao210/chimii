...
| --- | --- | --- |
| `workspace member list` | `user_id` (NOT the membership-row id) | `server/cmd/chimii/cmd_workspace.go:465` |
| `agent list` | `id` | `server/cmd/chimii/cmd_agent.go:365` |
| `squad list` | `id` | `server/cmd/chimii/cmd_squad.go:57` |
