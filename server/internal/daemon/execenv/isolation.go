...
// in the chimii binary. The daemon runs Prepare/Reuse in that subprocess so a
...
const PreparationHelperArg = "__chimii_execenv_prepare"
...
// name the current chimii binary followed by PreparationHelperArg in
