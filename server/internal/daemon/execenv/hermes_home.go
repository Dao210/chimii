...
//   - populates the task-local `skills/` dir with ONLY the Chimii-bound skills,
...
//     per-agent memory is a Chimii product concern — the host's local Hermes
...
const hermesTaskLocalStateMarker = ".chimii-task-local-state-v1"
...
// Chimii-bound skills. They keep their natural slug (no user skills share this
