...
func TestRenderManagedBlockWritableRoots(t *testing.T) {
	...
	policy.WritableRoots = []string{"/home/u/chimii_workspaces/ws/abc/home", "/home/u/chimii_workspaces/.repos/ws"}

	block := renderChimiiManagedBlock(policy)

	if !strings.Contains(block, `sandbox_workspace_write.writable_roots = ["/home/u/chimii_workspaces/ws/abc/home", "/home/u/chimii_workspaces/.repos/ws"]`) {
...
func TestRenderManagedBlockNoWritableRoots(t *testing.T) {
	...
	linux := renderChimiiManagedBlock(codexSandboxPolicyFor("linux", "0.121.0"))
	...
	block := renderChimiiManagedBlock(darwin)
