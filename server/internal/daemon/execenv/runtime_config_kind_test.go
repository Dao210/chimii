...
func TestBuildMetaSkillContentBriefContent(t *testing.T) {
	...
	if !strings.Contains(out, "- `chimii issue get <id> --output json` — full issue.\n") {
...
func TestSlimQuickCreateAvailableCommands(t *testing.T) {
	...
	for _, banned := range []string{
		...
		"chimii issue metadata set <issue-id>",
		"chimii issue metadata delete <issue-id>",
