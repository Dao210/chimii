...
// app-level token (xapp-) into Chimii (the paste path lives in byo_install.go).
...
var (
	...
	// already connected to a live owner in a DIFFERENT Chimii workspace — it
	...
	ErrTeamOwnedByAnotherWorkspace = errors.New("slack: this Slack app is already connected to a different Chimii workspace")
...
// the pasted Slack app is already connected to a DIFFERENT agent or Chimii
