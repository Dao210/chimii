...
//     and an expiry. Chimii renders the QR, the user scans it in the
...
type RegistrationConfig struct {
	...
	// telemetry can attribute installs back to Chimii. Empty defaults
	// to "chimii".
	Source string
...
type BeginResult struct {
	DeviceCode string
	// QRCodeURL is the verification_uri_complete with Chimii's `source`
...
// cannot attribute installs back to Chimii in their analytics.
//
