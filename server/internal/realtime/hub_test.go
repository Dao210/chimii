...
func TestCheckOrigin(t *testing.T) {
	...
	cases := []struct {
		...
		{"empty origin allowed", "api.chimii.ai", "", "", "1.2.3.4:5678", true},
		{"same-origin allowed (native client default)", "localhost:8080", "http://localhost:8080", "", "1.2.3.4:5678", true},
		{"same-origin allowed (https)", "api.chimii.ai", "https://api.chimii.ai", "", "1.2.3.4:5678", true},
		{"same-origin allowed (case-insensitive host, RFC 7230)", "API.Chimii.AI", "https://api.chimii.ai", "", "1.2.3.4:5678", true},
		{"whitelisted origin allowed (web cross-origin)", "localhost:8080", "http://localhost:3000", "", "1.2.3.4:5678", true},
		{"whitelisted origin allowed (prod web)", "api.chimii.ai", "https://chimii.ai", "", "1.2.3.4:5678", true},
		{"unknown origin rejected (CSWSH defense)", "api.chimii.ai", "https://evil.com", "", "1.2.3.4:5678", false},
		{"different port rejected", "localhost:8080", "http://localhost:9999", "", "1.2.3.4:5678", false},
		{"X-Forwarded-Host from trusted proxy matches origin", "internal.proxy", "https://chimii.ai", "chimii.ai", "127.0.0.1:5678", true},
		{"X-Forwarded-Host from trusted proxy case-insensitive", "internal.proxy", "https://Chimii.AI", "chimii.ai", "10.0.0.1:5678", true},
		{"X-Forwarded-Host from untrusted source rejected", "internal.proxy", "https://example.com", "example.com", "1.2.3.4:5678", false},
		{"X-Forwarded-Host from trusted proxy but evil origin rejected", "internal.proxy", "https://evil.com", "chimii.ai", "127.0.0.1:5678", false},
		{"X-Forwarded-Host present but origin matches direct Host", "chimii.ai", "https://chimii.ai", "other.host", "1.2.3.4:5678", true},
		{"X-Forwarded-Host spoofed by attacker rejected", "internal.proxy", "https://evil.com", "evil.com", "1.2.3.4:5678", false},
		{"X-Forwarded-Host from trusted CIDR range matches origin", "internal.proxy", "https://chimii.ai", "chimii.ai", "10.5.6.7:5678", true},
		{"X-Forwarded-Host from trusted IPv6 proxy matches origin", "internal.proxy", "https://chimii.ai", "chimii.ai", "[::1]:5678", true},
		{"X-Forwarded-Host comma list uses first (client-facing) value", "internal.proxy", "https://chimii.ai", "chimii.ai, proxy.internal", "127.0.0.1:5678", true},
		{"X-Forwarded-Host comma list ignores trailing values", "internal.proxy", "https://staging.chimii.ai", "proxy.internal, staging.chimii.ai", "127.0.0.1:5678", false},
	}
