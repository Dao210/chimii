...
// loadTrustedProxies reads the same CHIMII_TRUSTED_PROXIES env var the rest of
...
func loadTrustedProxies() []netip.Prefix {
	raw := strings.TrimSpace(os.Getenv("CHIMII_TRUSTED_PROXIES"))
	if raw == "" {
		return nil
	}
...
// shared CHIMII_TRUSTED_PROXIES value in here at startup.
