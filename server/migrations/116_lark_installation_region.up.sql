-- Add a per-installation `region` so one Chimii deployment can serve
...
-- deployment-wide value (the CHIMII_LARK_HTTP_BASE_URL /
-- CHIMII_LARK_CALLBACK_BASE_URL env knobs, defaulting to open.feishu.cn),
