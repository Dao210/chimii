...
func TestNewDaemonLogRotatorDefaults(t *testing.T) {
	os.Unsetenv("CHIMII_DAEMON_LOG_MAX_SIZE_MB")
	os.Unsetenv("CHIMII_DAEMON_LOG_MAX_BACKUPS")
	os.Unsetenv("CHIMII_DAEMON_LOG_MAX_AGE_DAYS")
...
func TestNewDaemonLogRotatorEnvOverride(t *testing.T) {
	t.Setenv("CHIMII_DAEMON_LOG_MAX_SIZE_MB", "5")
	t.Setenv("CHIMII_DAEMON_LOG_MAX_BACKUPS", "2")
	t.Setenv("CHIMII_DAEMON_LOG_MAX_AGE_DAYS", "7")
...
func TestDaemonLogRotatorRotates(t *testing.T) {
	t.Setenv("CHIMII_DAEMON_LOG_MAX_SIZE_MB", "1")
	t.Setenv("CHIMII_DAEMON_LOG_MAX_BACKUPS", "3")
