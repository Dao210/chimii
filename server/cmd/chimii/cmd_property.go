...
// chimii property {list|get|create|update|archive|unarchive} — workspace
// custom property definitions, and chimii issue property {list|set|unset} —
...
date, checkbox, url. Select types take repeatable --option flags:
  chimii property create --name Severity --type select \
