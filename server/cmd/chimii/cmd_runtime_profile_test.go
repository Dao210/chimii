...
func TestRunRuntimeProfileList(t *testing.T) {
	...
	t.Setenv("CHIMII_WORKSPACE_ID", "ws-123")
...
func TestRunRuntimeProfileSetPathPreservesExistingConfig(t *testing.T) {
	...
	seed := cli.CLIConfig{ServerURL: "https://api.chimii.ai", WorkspaceID: "ws-123", Token: "mul_xyz"}
	...
	if cfg.ServerURL != "https://api.chimii.ai" || cfg.WorkspaceID != "ws-123" || cfg.Token != "mul_xyz" {
