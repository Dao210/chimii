...
var rootHelpTemplate = `Work seamlessly with Chimii from the command line.

USAGE
  chimii <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
EXAMPLES
  ...
  $ chimii daemon start
  $ chimii agent list --output json

ENVIRONMENT VARIABLES
  CHIMII_SERVER_URL    Override the default server URL
  CHIMII_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`chimii <command> <subcommand> --help`" + ` for more information about a command.
`
