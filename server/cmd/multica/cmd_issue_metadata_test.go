...
// Tests for `chimii issue metadata list` 404-degradation behavior, plus
...
// endpoint working.
//
// Background: GitHub issue chimii-ai/chimii#3711 — on self-hosted
// backends that pre-date the per-issue metadata route, agent runtime
// bootstrap calls `chimii issue metadata list <issue> --output json`
