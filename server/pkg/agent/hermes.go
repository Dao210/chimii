...
// file write on the Hermes ACP runtime (GitHub chimii#5300).
...
// GitHub chimii#5300 it refuses to auto-select a permanent "allow_always"
...
func (c *hermesClient) extractPromptResult(data json.RawMessage) {
	...
	// usage map and Chimii's Usage/cost dashboards stay at zero.
...
// even when Chimii did not pass an explicit agent.model override.
...
// chimii#5862 — do not gate matching on length).
