...
import {
  ...
  DEFAULT_AVATAR_SIZE,
  type AvatarSize,
} from "@chimii/ui/lib/avatar-size";
import { parseAvatarEmoji } from "@chimii/ui/lib/avatar-emoji";
import { ChimiiIcon } from "./chimii-icon";
  ...
  return (
    ...
    >
      {emoji ? (
        ...
        <ChimiiIcon noSpin style={{ width: px * 0.55, height: px * 0.55 }} />
      ) : isAgent ? (
