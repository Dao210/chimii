...
const WORKSPACE_SCOPED_KEYS = [
  "chimii_issue_surface_views",
  "chimii_issues_view",
  "chimii_issues_scope",
  "chimii_my_issues_view",
  "chimii:chat:selectedAgentId",
  "chimii:chat:selectedProjectId",
  "chimii:chat:activeSessionId",
  "chimii:chat:expanded",
  "chimii_navigation",
];
