...
const AGENT_STORAGE_KEY = "chimii:chat:selectedAgentId";
const PROJECT_STORAGE_KEY = "chimii:chat:selectedProjectId";
const SESSION_STORAGE_KEY = "chimii:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "chimii:chat:drafts";
/** Draft attachment records per workspace: { [sessionId]: Attachment[] }. */
const DRAFT_ATTACHMENTS_KEY = "chimii:chat:draft-attachments";
/**
 ...
 */
const APPLIED_RESTORES_KEY = "chimii:chat:applied-draft-restores";
/**
 ...
 */
const PENDING_SEND_RESTORES_KEY = "chimii:chat:pending-send-restores";
/**
...
const CHAT_WIDTH_KEY = "chimii:chat:width";
const CHAT_HEIGHT_KEY = "chimii:chat:height";
const CHAT_EXPANDED_KEY = "chimii:chat:expanded";
/**
 ...
 */
const OPEN_KEY = "chimii:chat:isOpen";
/**
 ...
 */
const FLOATING_KEY = "chimii:chat:floatingChatEnabled";
