// Mirrors the chimii-cloud Billing module response shapes
// (chimii-cloud/docs/api/billing.md). These types are the contract our
// frontend consumes via /api/cloud-billing/* — chimii-api itself does
