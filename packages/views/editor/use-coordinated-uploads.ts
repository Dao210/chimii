 ...
 * coordinator (`@chimii/core/drafts`), not by the React component that
...
import {
  ...
  type DraftUpload,
} from "@chimii/core/drafts";
import { createSafeId } from "@chimii/core/utils";
import { contentReferencesAttachment, type Attachment } from "@chimii/core/types";
import {
  toUploadResult,
  type UploadContext,
  type UploadResult,
} from "@chimii/core/hooks/use-file-upload";
import { MAX_FILE_SIZE } from "@chimii/core/constants/upload";
