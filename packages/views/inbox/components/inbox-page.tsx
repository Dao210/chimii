...
} from "@chimii/core/inbox/mutations";
...
import {
  ...
  ResizablePanel,
  ResizableHandle,
} from "@chimii/ui/components/ui/resizable";
import { Skeleton } from "@chimii/ui/components/ui/skeleton";
import { NumberFlow } from "@chimii/ui/components/ui/number-flow";
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
  ...
  const detailContent = selected?.issue_id ? (
    ...
    <ErrorBoundary resetKeys={[selected.issue_id]}>
      <IssueDetail
        ...
        layoutId="chimii_inbox_issue_detail_layout"
