...
import type { Agent, ChatSession, Project } from "@chimii/core/types";
...
vi.mock("@chimii/views/issues/components", () => ({ canAssignAgent: () => true }));
...
vi.mock("@chimii/core/chat/mutations", () => ({
