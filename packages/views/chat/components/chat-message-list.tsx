...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@chimii/ui/components/ui/collapsible";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
...
import { isTaskMessageTaskId, taskMessagesOptions } from "@chimii/core/chat/queries";
...
import type { AgentAvailability } from "@chimii/core/agents";
import { resolveFailureReasonKey } from "@chimii/core/agents";
import type {
  ChatMessage,
  ChatPendingTask,
  TaskMessagePayload,
} from "@chimii/core/types";
import type { ChatTimelineItem } from "@chimii/core/chat";
...
function TimelineView({
  ...
  isStreaming?: boolean;
  attachments?: import("@chimii/core/types").Attachment[];
