...
import type { AgentRuntime, AgentTask } from "@chimii/core/types/agent";
import { useTranscriptViewStore } from "@chimii/core/agents/stores";
...
vi.mock("@chimii/ui/lib/clipboard", () => ({
...
vi.mock("@chimii/ui/components/ui/dropdown-menu", async () => {
...
vi.mock("@chimii/ui/components/ui/collapsible", async () => {
  const React = await import("react");
