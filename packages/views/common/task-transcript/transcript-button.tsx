...
import type { TaskMessagePayload } from "@chimii/core/types/events";
...
export function TranscriptButton({
  ...
  useEffect(() => {
    ...
    window.addEventListener("chimii:navigate", handleGlobalNavigate);
    return () => {
      window.removeEventListener("chimii:navigate", handleGlobalNavigate);
    };
  }, [open]);
