...
import { setApiInstance } from "@chimii/core/api";
import type { ApiClient } from "@chimii/core/api/client";
...
vi.mock("@chimii/core/issues/mutations", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@chimii/core/issues/mutations")>();
  return {
    ...actual,
...
vi.mock("@chimii/core/issues/stores/view-store-context", () => ({
