...
import { Skeleton } from "@chimii/ui/components/ui/skeleton";
import { Button } from "@chimii/ui/components/ui/button";
import { ResizablePanelGroup, ResizablePanel, ResizableHandle } from "@chimii/ui/components/ui/resizable";
import { Sheet, SheetContent } from "@chimii/ui/components/ui/sheet";
import { useIsMobile } from "@chimii/ui/hooks/use-mobile";
...
import { FileUploadButton } from "@chimii/ui/components/common/file-upload-button";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
} from "@chimii/ui/components/ui/tooltip";
import { Popover, PopoverTrigger, PopoverContent } from "@chimii/ui/components/ui/popover";
import { Dialog, DialogContent, DialogHeader, DialogTitle } from "@chimii/ui/components/ui/dialog";
import { Checkbox } from "@chimii/ui/components/ui/checkbox";
import { Command, CommandInput, CommandList, CommandEmpty, CommandGroup, CommandItem } from "@chimii/ui/components/ui/command";
import { AvatarGroup, AvatarGroupCount } from "@chimii/ui/components/ui/avatar";
import { ActorAvatar } from "../../common/actor-avatar";
import { PropRow } from "../../common/prop-row";
import { PropertyIcon } from "../../common/property-icon";
import type { Attachment, Issue, IssueProperty, IssueStatus, IssuePriority, TimelineEntry, UpdateIssueRequest } from "@chimii/core/types";
import { contentReferencesAttachment } from "@chimii/core/types";
import { STATUS_CONFIG, PRIORITY_CONFIG } from "@chimii/core/issues/config";
import { formatDateOnly, isPastDateOnly } from "@chimii/core/issues/date";
import { useUpdateIssue } from "@chimii/core/issues/mutations";
...
import { useGitHubSettings } from "@chimii/core/github";
import { useQuery } from "@tanstack/react-query";
import { useAuthStore } from "@chimii/core/auth";
import { useWorkspacePaths } from "@chimii/core/paths";
import { useActorName } from "@chimii/core/workspace/hooks";
import { useWorkspaceId } from "@chimii/core/hooks";
import { useRecentContextStore } from "@chimii/core/chat";
import { issueListOptions, issueDetailOptions, childIssuesOptions, childIssueProgressOptions, issueUsageOptions, issueAttachmentsOptions } from "@chimii/core/issues/queries";
import { projectDetailOptions } from "@chimii/core/projects/queries";
import { ProjectIcon } from "../../projects/components/project-icon";
import { issueLabelsOptions } from "@chimii/core/labels";
import { propertyListOptions } from "@chimii/core/properties";
import { memberListOptions, agentListOptions } from "@chimii/core/workspace/queries";
import {
...
} from "@chimii/core/issues/stores";
import { useIssueSelectionStore } from "@chimii/core/issues/stores/selection-store";
import { BatchActionToolbar } from "./batch-action-toolbar";
import { useIssueTimeline } from "../hooks/use-issue-timeline";
import { useIssueReactions } from "../hooks/use-issue-reactions";
import { useIssueSubscribers } from "../hooks/use-issue-subscribers";
import { ReactionBar } from "@chimii/ui/components/common/reaction-bar";
...
export function IssueDetail({ issueId, onDelete, onDone, defaultSidebarOpen = true, layoutId = "chimii_issue_detail_layout", highlightCommentId }: IssueDetailProps) {
  const { t } = useT("issues");
