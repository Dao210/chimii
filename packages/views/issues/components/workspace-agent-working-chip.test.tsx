...
import type { WorkspaceWorkingAgent } from "@chimii/core/types";
...
vi.mock("@chimii/ui/components/ui/button", async () => {
  const actual =
    await vi.importActual<typeof import("@chimii/ui/components/ui/button")>(
      "@chimii/ui/components/ui/button",
    );
  return {
    ...actual,
