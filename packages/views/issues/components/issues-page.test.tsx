...
// Mock @chimii/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@chimii/core/issues/stores/view-store", () => ({
...
vi.mock("@chimii/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@chimii/core/issues/stores/selection-store", () => ({
...
vi.mock("@chimii/core/issues/stores/recent-issues-store", () => ({
