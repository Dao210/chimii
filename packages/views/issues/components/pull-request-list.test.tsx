...
import type { GitHubPullRequest } from "@chimii/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@chimii/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@chimii/core/github/queries")>(
    "@chimii/core/github/queries",
  );
  return {
    ...actual,
