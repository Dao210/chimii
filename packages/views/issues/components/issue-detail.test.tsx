...
import type { Issue, Label, TimelineEntry } from "@chimii/core/types";
import { I18nProvider } from "@chimii/core/i18n/react";
import { useResolvedExpandStore } from "@chimii/core/issues/stores/resolved-expand-store";
import {
  DEFAULT_SUB_ISSUE_ROW_PROPERTIES,
  useSubIssueDisplayStore,
} from "@chimii/core/issues/stores/sub-issue-display-store";
...
vi.mock("@chimii/ui/hooks/use-mobile", () => ({
  useIsMobile: () => mockViewport.isMobile,
}));

// useWorkspaceId() derives from useCurrentWorkspace (relative import inside
// @chimii/core/hooks.tsx). vi.mock("@chimii/core/paths") only intercepts
...
// Mock @chimii/core/workspace/hooks
vi.mock("@chimii/core/workspace/hooks", () => ({
  useActorName: () => ({
...
// Mock @chimii/core/paths — after the URL-driven workspace refactor,
...
vi.mock("../../navigation", () => ({
  ...
  useNavigation: () => ({
    ...
    getShareableUrl: (p: string) => `https://app.chimii.com${p}`,
  }),
...
// Mock issue config
vi.mock("@chimii/core/issues/config", () => ({
...
vi.mock("@chimii/core/issues/stores", async () => ({
  ...
  ...(await vi.importActual<
    typeof import("@chimii/core/issues/stores/resolved-expand-store")
  >("@chimii/core/issues/stores/resolved-expand-store")),
  ...
  ...(await vi.importActual<
    typeof import("@chimii/core/issues/stores/sub-issue-display-store")
  >("@chimii/core/issues/stores/sub-issue-display-store")),
...
// Mock react-resizable-panels (used by @chimii/ui/components/ui/resizable)
