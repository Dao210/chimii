...
import { clearWorkspaceStorage, defaultStorage } from "@chimii/core/platform";
import { resetAllRegisteredDrafts } from "@chimii/core/drafts/cleanup-registry";
...
export function useLogout() {
  ...
  return useCallback(() => {
    ...
    defaultStorage.removeItem("chimii_tabs");
