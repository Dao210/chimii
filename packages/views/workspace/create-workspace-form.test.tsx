...
vi.mock("@chimii/core/workspace/mutations", () => ({
...
describe("CreateWorkspaceForm", () => {
  ...
  it("shows the brand host as the URL prefix when no app URL is configured", () => {
    renderForm();
    expect(screen.getByText("chimii.ai/")).toBeInTheDocument();
  });

  it("shows the deployment host as the URL prefix for self-hosted instances", () => {
    configStore.setState({ daemonAppUrl: "https://chimii.example.com" });
    renderForm();
    expect(screen.getByText("chimii.example.com/")).toBeInTheDocument();
    expect(screen.queryByText("chimii.ai/")).not.toBeInTheDocument();
  });
