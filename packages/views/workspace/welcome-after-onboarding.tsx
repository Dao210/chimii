...
import { paths, useCurrentWorkspace } from "@chimii/core/paths";
import { resolvePublicFileUrl } from "@chimii/core/workspace/avatar-url";
import { issueKeys } from "@chimii/core/issues/queries";
import { workspaceKeys } from "@chimii/core/workspace/queries";
import type { Agent, CreateIssueRequest, Issue } from "@chimii/core/types";
import {
  Dialog,
  DialogContent,
  DialogDescription,
 ...
 * the Zustand welcome-store signal that onboarding's automatic runtime
 * probe parks before navigating. Renders null when there is no signal or
 * when the signal has been dismissed.
 *
 * Two sub-templates driven by `signal.choice`:
 *
 *   "runtime":
 *     1. Full-screen loading veil ("Preparing your Helper…")
 *     2. Find-or-create a "Chimii Helper" agent on the picked runtime
