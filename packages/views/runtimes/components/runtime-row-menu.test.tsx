...
import type { AgentRuntime, RuntimeProfile } from "@chimii/core/types";
...
vi.mock("@chimii/core/runtimes/mutations", () => ({
...
describe("runtime list CLI column", () => {
  ...
  // shared chimii daemon `cli_version`. It must instead show the agent's own
