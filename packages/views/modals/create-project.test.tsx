...
const longRepoUrl =
  "https://github.com/chimii-ai/a-very-long-repository-name-that-needs-a-tooltip";
const apiRepoUrl = "https://github.com/chimii-ai/api";
const webRepoUrl = "https://github.com/chimii-ai/web";

vi.mock("@tanstack/react-query", () => ({
  useQuery: () => ({ data: [] }),
}));

vi.mock("@chimii/core/projects/mutations", () => ({
  useCreateProject: () => ({ mutateAsync: vi.fn() }),
}));

vi.mock("@chimii/core/projects", () => ({
...
vi.mock("@chimii/ui/components/ui/popover", () => ({
...
vi.mock("@chimii/ui/components/common/emoji-picker", () => ({
  EmojiPicker: () => null,
}));
