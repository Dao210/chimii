...
import { Tooltip, TooltipTrigger, TooltipContent, TooltipProvider } from "@chimii/ui/components/ui/tooltip";
...
import { useCurrentWorkspace, useWorkspacePaths } from "@chimii/core/paths";
import { useWorkspaceId } from "@chimii/core/hooks";
import { useIssueDraftStore, type IssueCreateDraft } from "@chimii/core/issues/stores/draft-store";
import { useCreateModeStore } from "@chimii/core/issues/stores/create-mode-store";
import { useQuickCreateStore } from "@chimii/core/issues/stores/quick-create-store";
import {
  useIssueCreateSettingsStore,
  type ManualCreateField,
} from "@chimii/core/issues/stores/issue-create-settings-store";
import { issueDetailOptions, childIssuesOptions } from "@chimii/core/issues/queries";
import { useCreateIssue, useUpdateIssue } from "@chimii/core/issues/mutations";
import { useAttachLabelToIssue } from "@chimii/core/labels";
import {
  propertyListOptions,
  useSetIssueProperty,
} from "@chimii/core/properties";
import {
  ApiError,
  DuplicateIssueErrorBodySchema,
  type DuplicateIssueErrorBody,
  parseWithFallback,
} from "@chimii/core/api";
...
import { Dialog as DialogRoot } from "@chimii/ui/components/ui/dialog";
