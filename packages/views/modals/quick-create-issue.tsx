...
import { DialogTitle } from "@chimii/ui/components/ui/dialog";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import { agentListOptions, squadListOptions } from "@chimii/core/workspace/queries";
import { projectListOptions } from "@chimii/core/projects/queries";
import {
  useQuickCreateStore,
  type QuickCreateActorType,
} from "@chimii/core/issues/stores/quick-create-store";
import {
...
import { memberListOptions } from "@chimii/core/workspace/queries";
import {
  ContentEditor,
...
export function AgentCreatePanel({
  ...
  // bundled chimii CLI to be ≥ MIN_QUICK_CREATE_CLI_VERSION; older
