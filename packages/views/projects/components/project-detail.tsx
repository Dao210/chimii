...
import type { ProjectStatus, ProjectPriority } from "@chimii/core/types";
import { useAuthStore } from "@chimii/core/auth";
import { projectDetailOptions } from "@chimii/core/projects/queries";
import { useUpdateProject, useDeleteProject } from "@chimii/core/projects/mutations";
import { pinListOptions } from "@chimii/core/pins";
import { useCreatePin, useDeletePin } from "@chimii/core/pins";
...
import { PROJECT_STATUS_ORDER, PROJECT_STATUS_CONFIG, PROJECT_PRIORITY_ORDER } from "@chimii/core/projects/config";
...
import {
  ...
  DropdownMenuTrigger,
} from "@chimii/ui/components/ui/dropdown-menu";
import {
  Popover,
  PopoverTrigger,
  PopoverContent,
} from "@chimii/ui/components/ui/popover";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
} from "@chimii/ui/components/ui/tooltip";
import { EmojiPicker } from "@chimii/ui/components/common/emoji-picker";
...
export function ProjectDetail({ projectId }: { projectId: string }) {
  ...
  const { defaultLayout, onLayoutChanged } = useDefaultLayout({
    id: "chimii_project_detail_layout",
  });
