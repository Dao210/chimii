...
import { slackInstallationsOptions, slackKeys } from "@chimii/core/slack";
import { api } from "@chimii/core/api";
import type { SlackInstallation } from "@chimii/core/types";
...
// path is per-agent (each Chimii agent gets exactly one bot — the
  ...
  const prefix = lang?.startsWith("zh")
    ...
    : lang?.startsWith("ja")
      ...
      : lang?.startsWith("ko")
        ? "/ko"
        : "";
  return `https://chimii.ai/docs${prefix}/slack-bot-integration`;
}
