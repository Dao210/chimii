...
vi.mock("@chimii/core/github", async () => {
  const actual =
    await vi.importActual<typeof import("@chimii/core/github")>("@chimii/core/github");
  return {
    ...actual,
...
describe("GitHubTab", () => {
  ...
  it("clicking Disconnect opens the confirmation and only fires on confirm", async () => {
    ...
    expect(screen.getByText(/Chimii will stop receiving webhooks/i)).toBeTruthy();
