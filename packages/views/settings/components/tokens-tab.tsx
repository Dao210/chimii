...
import type { PersonalAccessToken } from "@chimii/core/types";
import { Alert, AlertDescription } from "@chimii/ui/components/ui/alert";
...
export function TokensTab() {
  ...
  const handleCopyCommand = async () => {
    if (!newToken) return;
    if (await copyText(`chimii login --token ${newToken}`)) {
