...
vi.mock("@chimii/core/i18n/react", async () => {
  const actual =
    await vi.importActual<typeof import("@chimii/core/i18n/react")>(
      "@chimii/core/i18n/react",
    );
  return {
    ...actual,
    useLocaleAdapter: () => ({
...
import { useCommentComposerStore } from "@chimii/core/issues/stores";
