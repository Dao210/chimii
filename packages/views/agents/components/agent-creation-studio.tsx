...
const BUILDER_INPUT_PREFIX = "CHIMII_AGENT_BUILDER_INPUT\n";
 ...
 * for the user to pick again — the same rule `chimii agent copy` already
 ...
 * concurrency) — mirroring `chimii agent copy`.
 */
