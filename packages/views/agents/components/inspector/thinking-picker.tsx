...
import type { RuntimeModelThinkingLevel } from "@chimii/core/types";
 ...
 * the user's local CLI install, not by Chimii's catalog.
 */
      ...
      {levels.map((l) => (
        ...
        >
          ...
          {/* No model-factory-default badge here on purpose: when the
              picker is "Follow CLI config" (value === ""), Chimii omits
