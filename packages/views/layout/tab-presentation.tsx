...
import { autopilotDetailOptions } from "@chimii/core/autopilots/queries";
import {
  skillDetailOptions,
  agentListOptions,
  memberListOptions,
...
import { runtimeListOptions } from "@chimii/core/runtimes/queries";
...
} from "@chimii/core/inbox/queries";
 ...
 * core is `@chimii/core/paths` (`parseTabSubject` + `resolveTabPresentation`).
 *
