...
import { ActorAvatar } from "@chimii/ui/components/common/actor-avatar";
...
import {
  ...
  SidebarMenuItem,
  SidebarRail,
} from "@chimii/ui/components/ui/sidebar";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
...
import { useCurrentWorkspace, useWorkspacePaths, paths } from "@chimii/core/paths";
import { workspaceListOptions, myInvitationListOptions, workspaceKeys } from "@chimii/core/workspace/queries";
...
import { pinListOptions } from "@chimii/core/pins/queries";
import { useDeletePin, useReorderPins } from "@chimii/core/pins/mutations";
import { issueDetailOptions } from "@chimii/core/issues/queries";
import { projectDetailOptions } from "@chimii/core/projects/queries";
import type { PinnedItem } from "@chimii/core/types";
